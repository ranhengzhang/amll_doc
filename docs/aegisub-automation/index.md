...
适用于 Aegisub 的自动化脚本集合。

## 脚本列表

- [ass2lyric](./ass2lyric.md) 系列 - ASS 特效字幕导出为歌词文件
  - [ass2spl]() - 导出为 SPL 歌词文件 (Salt Player Lyric)
  - [ass2ttml]() - 导出为旧版 TTML 歌词（仅支持逐行翻译和音译）
  ...
  - [ass2ttmlv2](./ass2lyric3.md) - 增加了更多功能的版本
- [helper-scripts](./helper-scripts.md) - 辅助脚本
- [other-scripts](./other-scripts.md) - 其他脚本
